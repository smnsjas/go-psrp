...
type RunspaceBackend interface {
	...
	// It returns a cleanup function that should be called after the pipeline completes.
	PreparePipeline(ctx context.Context, p *pipeline.Pipeline, content string) (func(), error)
